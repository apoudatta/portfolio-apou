...
const Footer = () => {
    return (
        <div className='py-2 mx-4 md:py-12 md:mx-44'>
            <div className='flex flex-col md:flex-row justify-between gap-5'>
                <div className=''>
                    ...
                    <div>
                        <p className='text-xl max-w-md'>I am a software developer with 7 years of experience</p>
                    </div> */}
                </div>
            ...
            <div className='flex justify-between'>
                <p className='text-lg'>© 2026 Apou Datto. All rights reserved.</p>
